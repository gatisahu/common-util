...
public class TestListStack {
	...
	private Stack<String> createNewStack(int initialCapacity) {
		return new ArrayStack<String>(initialCapacity);
	}

	@Test
	public void should_test_empty_stack() {
		Stack<String> stack = createNewStack(2);
	...
	public void should_test_multiple_push() {
		Stack<String> stack = createNewStack(1);
		int iteration = 10;
		// Push multiple item
